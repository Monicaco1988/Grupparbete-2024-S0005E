...
public partial class ExplosionMarker3 : Marker3D
{
    ...
    public override void _Ready()
    {
        ...
        if (_player.HasNode("/root/GameManager/PlayerManager/@Node3D@3"))
        {
            _player = GetNode<Node3D>("/root/GameManager/PlayerManager/@Node3D@3");
    ...
    public void OnScreenExist()
    {
        if (_player.HasNode("/root/GameManager/PlayerManager/@Node3D@3"))
        {
            ...
            _player.GetNode<Node3D>("/root/GameManager/PlayerManager/@Node3D@3").Hide();
        }
    }
}
